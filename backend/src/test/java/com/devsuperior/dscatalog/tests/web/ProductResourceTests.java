...
@SpringBootTest
@AutoConfigureMockMvc                      // Não carregar o servidor Tomcat
public class ProductResourceTests {
	...
	@MockBean										// Mock apenas o ProductService
	...
	private Double priceNegavite;
	private ProductDTO newProductDTO;
	private ProductDTO existingProductDTO;
	private ProductDTO priceNegativeProductDTO;
	...
	public void insertShouldReturnUnprocessableEntityWhenNegativePrice() throws Exception {
		...
		ResultActions result =
				mockMvc.perform(post("/products", priceNegativeProductDTO)
					.header("Authorization", "Bearer " + accessToken)
					.content(jsonBody)
	...
	public void findAllShouldReturnPage() throws Exception {
		...
		result.andDo(print())
			  .andExpect(status().isOk());                 // Espero retorna OK
	...
	public void findByIdShouldReturnNotFoundWhenIdDoesNotExists() throws Exception {
		...
		result.andDo(print())
			  .andExpect(status().isNotFound());           // Espero retorna NotFound
	...
	private String obtainAccessToken(String username, String password) throws Exception {
	    ...
	    String resultString = result.andReturn().getResponse().getContentAsString();   // transformar os valores em string
	 
	    JacksonJsonParser jsonParser = new JacksonJsonParser();
	    return jsonParser.parseMap(resultString).get("access_token").toString();		// Fazer um parser no string como json, e pegar o atributo "access_token"
	}	
}